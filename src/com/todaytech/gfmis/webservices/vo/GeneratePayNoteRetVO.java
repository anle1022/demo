...
public class GeneratePayNoteRetVO  extends com.todaytech.gfmis.webservices.common.GenericRetVO  implements java.io.Serializable {
    ...
    public String toString() {
		return "GeneratePayNoteRetVO [pnNO=" + pnNO + "],"+super.getReason()+"],"+super.getReturnCode();
	}
